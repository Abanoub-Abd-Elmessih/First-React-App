...
export default function Contact() {
  ...
  return (
    <div className="container py-48 mx-auto text-secColor flex flex-col ">
      <h5 className="font-bold text-4xl text-center uppercase mb-4">Contact Section</h5>
      <Divider borderColor="border-secColor" starColor="text-secColor" />
      <form className="py-20 mx-auto w-3/4 flex flex-col gap-8">
        ...
        <button type="button" className="p-2 text-lg rounded-lg bg-mainColor cursor-pointer outline-0 text-white w-fit active:scale-90 transition-all duration-300">Send Message</button>
      </form>
    </div>
  );
}
