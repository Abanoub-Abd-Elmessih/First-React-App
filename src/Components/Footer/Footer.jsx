          ...
          <div className="container mx-auto text-center">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              <div className="col-span-1">
                <h3 className="font-semibold text-3xl md:text-4xl my-3">LOCATION</h3>
                <p>Alexandria, Egypt</p>
                <p className="mt-2">Miami</p>
              </div>
              <div className="col-span-1">
                <h3 className="font-semibold text-2xl md:text-3xl my-4">AROUND THE WEB</h3>
                <ul className="flex gap-4 w-full justify-center text-xl">
                  <li className="border border-white rounded-full flex items-center hover:bg-teal-500 duration-300 cursor-pointer">
                    <a href="https://github.com/Abanoub-Abd-Elmessih" target="_blank">
                  ...
                  <li className="border border-white rounded-full flex items-center hover:bg-teal-500 duration-300 cursor-pointer">
                    <a href="https://www.facebook.com/people/Abanoub-Abd-Elmessih/pfbid02TUnTdbsgoVigfo6drPDGKmz3F1drYFnCZe9a9Cf8SGHxpnqFrZf5RfP8uBrmZyx2l/" target="_blank">
              ...
              <div className="col-span-1">
                <h3 className="my-3 font-semibold text-2xl md:text-3xl">ABOUT FREELANCER</h3>
